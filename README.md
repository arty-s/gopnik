...
Из `g.exe` взяты тексты, названия, 11 типов врагов, 43 звания понтовости,
семь мест района и формулы из встроенной справки: `Здоровье = 10 + Живучесть×5 + Сила`,
`Урон = Сила/2 … Сила`, 12 очков навыков на старте, рост навыка на уровне
с шансом «своё значение из 12».

Изменены точность, здоровье врагов и масштабирование по уровням — с буквальными
числами оригинала бой не сходился. Каждое отклонение помечено комментарием
в `src/Game/Model.cs`.
